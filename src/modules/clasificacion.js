...
class clasificacion extends Component {
    ...
    search = () => {
        ...
        return fetch('http://ec2-54-87-46-119.compute-1.amazonaws.com:5001/api/arancel/getarancelbychapter/'+this.state.product)
            ...
            <Container>
                <Header searchBar style={styles.header}>
                    <Item>
                        ...
                        <Input
                            value={product}
                            placeholder="ingresa el producto ex:05, 06, 07, etc"
