...
class clasificacion extends Component {
    ...
    search = () => {
        ...
        return fetch('http://ec2-54-87-46-119.compute-1.amazonaws.com:5001/api/arancel/getsubpartidasgeneralesbycapitulo/'+this.state.product)
            ...
            <Container>
                <Header searchBar style={styles.header}>
                    <Item>
                        ...
                        <Input
                            value={product}
                            placeholder="ingresa el producto for ex. 1,2,3,4,5"
                            ...
                            <List dataArray={this.state.dataSource}
                                ...
                                renderRow={(item) =>
                                    <ListItem onPress={() => {
                                        ...
                                        <Body>
                                            <Text>{item.subpartida}</Text>
                                            <Text note>{item.descripcion}</Text>
                                        </Body>
                                    </ListItem>}>
                            </List>
                        </View>
